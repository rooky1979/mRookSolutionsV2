    ...
    >
      <div className={educationhomeStyles.quotecontainer}>
        ...
        <p className={educationhomeStyles.quote}>
          &quot;I love learning, and it will be a never-ending quest. I believe
          the key is to remain humble and without ego. That keeps me open-minded
          to new ideas and remain teachable. I try to surround myself with
          smarter people; I listen and soak it in. Success always leaves clues
          to follow.&quot;
        </p>
