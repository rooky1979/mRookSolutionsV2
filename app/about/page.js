    ...
    <>
      ...
      <div className={aboutStyles.aboutcontainer}>
        ...
        >
          <img
            src="/me.jpeg"
            alt="Me at Stonehenge"
            onClick={() => openModel("/me.jpeg")}
          />
        </motion.div>
        <motion.div
        ...
        >
          ...
          <br />
          <p className={aboutStyles.text}>
            In 2014 during a big project of installing, upgrading, and
            qualifying HPLCs, and their PCs I wished I had gone into IT instead
            of science, but telling myself not to do anything about it with
            things like &quot;I&apos;m too old&quot;, or &quot;I can&apos;t
            afford to go to University, I have a mortgage to pay&quot;. I
            recognise now exactly those &quot;justifications&quot; for what they
            were..... Excuses and Fear.
          </p>
          <br />
          <p className={aboutStyles.text}>
            In 2017 after some self-reflection came to pass, I decided to go for
            it. No more self-justifications, rationalisations, and excuses. I
            enrolled at AUT full-time in a BSc Computer and Information Sciences
            degree majoring in Software Development, and I have never looked
            back. To switch careers at 39 was one of the scariest things I have
          ...
          <p className={aboutStyles.text}>
            ...
            trust, which is the foundation of any relationship, both business
            and personal.
          </p>
          <br />
          <p className={aboutStyles.text}>
          ...
          <br />
          <p className={aboutStyles.text}>
            But don&apos;t let my cheerful demeanour fool you. When it&apos;s
            time to get down to business, I am a man of sheer will and
            determination. I get things done. I say what I&apos;ll do and do
            what I say.
          </p>
        </motion.div>
        <motion.div
        ...
        >
          <img
            src="/family.jpeg"
            alt="Family at Disney"
            onClick={() => openModel("/family.jpeg")}
          />
        </motion.div>
        {isModalOpen && (
